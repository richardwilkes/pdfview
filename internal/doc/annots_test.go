...
// TestAnnotationSelection pins which annotations yield a renderable appearance at all; each case was pinned by an
// oracle probe (see the selection rules in annots.go).
