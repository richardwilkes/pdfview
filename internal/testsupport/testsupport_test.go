...
// agrees with its own page/DPI/needle structure, and every referenced PNG decodes to the recorded dimensions. A golden
// corrupted in the tree (line endings, encoding) is reported here rather than as a parity failure elsewhere.
