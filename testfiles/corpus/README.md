...
## Annotation probe (M8, generated 2026-07-11)
...
was pinned against the oracle by scratch probes BEFORE the file was generated — see the M8 /AP decision-log entry
in plan.md. The file deliberately contains NO appearance-synthesis arms (no /AP-less markup annotations, no
checkbox whose /AS names a missing non-/Off state), since MuPDF's synthesized appearances are out of scope.
